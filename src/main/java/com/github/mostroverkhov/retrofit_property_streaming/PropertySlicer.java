...
class PropertySlicer<T> {
  ...
  /**
   * @return next property. It is an error to call {@link #nextProp()} after property with type
   * {@link PropType#DOC_END} was returned
   */
      ...
      <T> Prop<T> resolve(String propName, Type targetType, PropertySlicer<T> calculator)
        ...
        if (itemName == null || itemType == null) {
          throw new AssertionError(
              "Internal error: itemName and itemType were not set for array item:ARR");
        }
